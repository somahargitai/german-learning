...
const colors = [
  // színek
  { pronoun: 'das', de: 'Blau', hu: 'kék', de_pl: 'Blau' },
  { pronoun: 'die', de: 'Grün', hu: 'zöld', de_pl: 'Grün' },
  { pronoun: 'die', de: 'Rot', hu: 'piros', de_pl: 'Rote' },
  { pronoun: 'die', de: 'Weiß', hu: 'fehér', de_pl: 'Weiß' },
  { pronoun: 'die', de: 'Gelb', hu: 'sárga', de_pl: 'Gelb' },
];

export default adjectiveComparativeAndSuperlativeList;
